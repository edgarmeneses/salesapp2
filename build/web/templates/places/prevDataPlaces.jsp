                            ...
                            <div class="content">
                                ...
                                <table name="table" id="table" class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        %>
                                        <tr name="lugares">
                                            <td id="sub"><input name="" id="place" type="text" value="<%= data.get(i)[0] %>" class="form-control" > </td>
                                            <td><input name="" id="names" type="text" value="<%= data.get(i)[1] %>" class="form-control" > </td>
                                            <td><input name="" id="types" type="text" value="<%= data.get(i)[2] %>" class="form-control"> </td>
