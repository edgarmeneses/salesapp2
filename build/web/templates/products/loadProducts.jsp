    ...
    <div class="main-panel">
        ...
        <div class="breadcrumb2">
            <div class="btn-group btn-breadcrumb btn-fill">
                ...
                <a class="btn btn-info btn-fill">Productos</a>
                                     ...
                                     <div class="row">
                                         <div class="col-md-5 col-md-offset-0">
                                             <div class="form-group">
                                                 <label>Archivo productos (csv)</label>
                                ...
                                <table name="table" id="table" class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <%= products.get(i).getHallmark().toUpperCase() %> </td>
                                            <td> <%= products.get(i).getQuantityMin() %> </td>                                           
                                            <td> <%= products.get(i).status()%> </td>
