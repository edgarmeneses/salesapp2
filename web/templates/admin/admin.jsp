                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="content">
                                 <img src="public/assets/img/modelbd.png"> </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 col-md-offset-0">
                        <div class="card card-user">
                            <div class="image" style="background: #204d74; text-align: center;">
                                <label id="text">Consultas</label>
                            </div>
                           <div class="content">
                               <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="bodyQuery" rows="15" class="form-control" placeholder="Ingrese una consulta..."></textarea>
                                            </div>
                                        </div>
                                </div>
                            </div>
                            ...
                            <div class="text-center">
                                <button id="query" type="button" class="btn btn-primary btn-fill pull-right" >Enviar</button>
